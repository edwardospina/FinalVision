...
output_folder = os.path.join("data", "VideosMobileNetV3")
os.makedirs(output_folder, exist_ok=True)
output_video_path = os.path.join(output_folder, f"{video_name.replace('.avi', '')}_mobilenet.avi")

# === Modelo (MobileNetV3 backbone) ===
model = torch.hub.load("pytorch/vision", "deeplabv3_mobilenet_v3_large", pretrained=True).eval()
...
print("✅ Video final (MobileNetV3) generado correctamente.")
